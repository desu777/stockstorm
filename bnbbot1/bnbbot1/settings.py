"""
Django settings for bnbbot1 project.
...
WSGI_APPLICATION = 'bnbbot1.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bnb',  # Nazwa bazy danych
        'USER': 'root',  # Nazwa użytkownika MySQL
        'PASSWORD': '190DHQ0goPln',  # Hasło użytkownika
