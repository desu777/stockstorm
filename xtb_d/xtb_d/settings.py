"""
Django settings for xtb_d project.
...
SECRET_KEY = 'django-insecure-q554y*)zxadx*nto93h$+89y4o3imb+=hstyylk%%(1$w(pgcx'
...
WSGI_APPLICATION = 'xtb_d.wsgi.application'
